...
using InfernalRoboticsMinimal.Command;
using InfernalRoboticsMinimal.Control.Servo;
using InfernalRoboticsMinimal.Effects;
using KSP.IO;
using UnityEngine;
//using TweakScale;

namespace InfernalRoboticsMinimal.Module
{
    public class ModuleIRServo : PartModule, /*IRescalable,*/ IJointLockState
    {

        #region Servo&Utility related KSPFields
        ...
        #endregion Servo&Utility related KSPFields

        #region Mechanism related KSPFields
        ...
        */
        ...
        #endregion Mechanism related KSPFields

        #region Motor related KSPFields
        ...
        #region All KSPEvents&KSPActions
        ...
        #endregion all KSPEvents & KSPActions
