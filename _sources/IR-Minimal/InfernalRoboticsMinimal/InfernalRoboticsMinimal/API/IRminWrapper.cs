...
namespace InfernalRoboticsMinimal.API
{    public class IRminWrapper
    {
        ...
        private class InfernalRoboticsMinimalAPI : IRAPI
        {
            private PropertyInfo apiReady;
            private object actualServoGroups;

            public InfernalRoboticsMinimalAPI()
            {
                DetermineReady ();
                BuildServoGroups ();
            }
        ...
        public class IRServo : IServo
        {
            ...
            private MethodInfo setToMethod;
            private MethodInfo stopMethod;
            ...
            private void FindMethods ()
            {
                ...
                setToMethod = IRServoMotorType.GetMethod("SetTo", new[] { typeof(float) });
            }
            ...
            public void SetTo(float position)
            {
                setToMethod.Invoke(actualServoMotor, new object[] { position });
            }
