    ...
    public static class DrawTools
    {
        ...
        private static Material material
        {
            get
            {
                if (_material == null)
                {
                    _material = new Material(Shader.Find("KSP/Particles/Alpha Blended"));
                }
                return _material;
            }
        }
        ...
        public static void DrawLine(Transform origin, Transform destination, Color color)
        {
            GLStart();

            DrawLine(origin.position, destination.position, color);
